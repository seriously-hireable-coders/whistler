...
const Signin = () => {
  ...
  return <form className="bg-pink-200 flex flex-col py-12 px-8 rounded-lg w-8/12 md:w-6/12 mx-auto gap-10">
    <h2 className="text-3xl font-bold text-center">Sign in to your Whistler account you beautiful person!</h2>
    ...
    <p className="text-center text-xl">Don't have an account? Why?</p>
